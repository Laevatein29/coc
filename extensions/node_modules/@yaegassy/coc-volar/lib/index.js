...
var require_protocol2 = __commonJS({
  "node_modules/@vue/language-server/out/protocol.js"(exports) {
    ...
    (function(GetDragAndDragImportEditsRequest2) {
      GetDragAndDragImportEditsRequest2.type = new vscode.RequestType("vue/dragImportEdits");
...
function getDisabledFeatures() {
  ...
  if (import_coc10.workspace.getConfiguration("volar").get("disableCompletion")) {
